    ...
    FileService fileService) : Controller
{
    ...
    public async Task<IActionResult> ProductList()
    {
        ...
        [
            new() { Name = "Pen 1", Description = "Description 1", Price = 100, UserId = user!.Id },
            new() { Name = "Pen 2", Description = "Description 2", Price = 200, UserId = user!.Id },
            new() { Name = "Pen 3", Description = "Description 3", Price = 300, UserId = user!.Id },
            new() { Name = "Pen 4", Description = "Description 4", Price = 400, UserId = user!.Id },
            new() { Name = "Pen 5", Description = "Description 5", Price = 500, UserId = user!.Id }
        ];
